-- Migration: OpenAPI (Swagger) definitions in the full heartbeat (H2)
...
CREATE INDEX IF NOT EXISTS idx_bi_service_openapi_definitions_runtime_id ON bi_service_openapi_definitions (runtime_id);
